...
function initiate_edit(ev) {
  ...
  let target_parent = ev.target.parentElement;
  target_parent.innerHTML = "";
  target_parent.appendChild(edit_form)
...
function create_edit_input(input_value) {
  ...
  cancel_btn.classList.add('btn', 'btn--cancel-btn')
  cancel_btn.id = 'cancel-btn'
  cancel_btn.textContent = 'Cancel'
  edit_form_container.appendChild(cancel_btn);
